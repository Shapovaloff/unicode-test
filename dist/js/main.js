...
if (breakpoint) {
  ...
  var _openMobileMenu = function _openMobileMenu() {
...
function openMobileMenu() {
  ...
  var menuNavigation = document.querySelector('.js-menu-navigation');
  var body = document.querySelector('body');
  var btnToLang = document.querySelector('.js-btn-mobile-lang');
  var languageBlock = document.querySelector('.js-language-mobile');
  var languageList = document.querySelector('.language-select');
  var languageBtn = document.querySelector('.js-language-btn');
